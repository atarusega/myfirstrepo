...
_EVENT_KW = [
    (r"нов\w* год|новогод|\bнг\b|корпоратив\w* в декабре", "newyear"),
    (r"корпорат|конференц|компани|бизнес", "corporate"),
    (r"свадьб|день рожд|\bдр\b|юбиле|выпускн|вечеринк|праздник", "private"),
]
_GENRE_KW = {
    "rock": r"рок",
    "jazz_lounge": r"джаз|лаунж|свинг|lounge|jazz",
    # «80-х», «хиты 90х», «80-90х»; голые числа — это гости, возраст и бюджет, не жанр
    "retro": r"ретро|\b[5-9]0-?[хx]|\b[5-9]0-[5-9]0|хиты [5-9]0|семидесят|восьмидесят|девяност",
    ...
    "pop": r"\bпоп\b|\bпоп-|\bпопс",  # не «популярная»
}
_INSTR_KW = {
    "sax": r"саксоф|сакс\b",
